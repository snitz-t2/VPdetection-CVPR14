...
py::array_t<double> detect_alignments_slow(py::array_t<double, py::array::c_style | py::array::forcecast> points_in,             /* input_points | Input points (Nx2 matrix).            */
...
std::string detect_alignments_slow_doc = R""""(ALIGNMENTS_SLOW Point alignment detection, full version
                                              -----------------------------------------------------------------------------------------------------------
